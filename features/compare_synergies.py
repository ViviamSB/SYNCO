...
def compare_synergies(
        ...
        synergy_column: str = 'synergy',
        threshold: float = 0.5,
        type: str = 'cell_line', # 'cell_line' or 'inhibitor_combination'
    ...
    # Find common items and items that will be skipped
    exp_items, pred_items, common_items, skipped_exp, skipped_pred = _find_common_and_skipped_items(df_exp, df_pred, type)
    ...
    _print_comparison_summary(type, exp_items, pred_items, common_items, skipped_exp, skipped_pred,)
    ...
    _print_comparison_summary(type, results_df=results_df)

    if output_path:
        save_file(results_df, output_path, file_type='csv')
